      ...
      <main className="flex-grow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-dark-900 dark:text-white leading-tight">
                  Your memories, <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-accent-500">beautifully preserved</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <Link to="/signup" className="w-full sm:w-auto">
                    <Button 
                      ...
                      icon={<ArrowRight className="h-5 w-5 ml-1 group-hover:translate-x-1 transition-transform" />}
                    >
                      Get Started
                    </Button>
                  </Link>
                ...
                <div className="pt-4 flex items-center">
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4].map((i) => (
                      <div key={i} className={`w-8 h-8 rounded-full border-2 border-white dark:border-gray-800 bg-primary-${i*100} dark:bg-primary-${900-i*100}`}></div>
                    ))}
                  </div>
                  <div className="ml-3 text-sm text-gray-600 dark:text-gray-400">
                    <span className="font-medium text-dark-900 dark:text-white">1,000+</span> happy users
                  </div>
                </div>
              </div>
        ...
        <section className="py-24 bg-gradient-to-br from-dark-800 to-dark-900 text-white relative overflow-hidden">
          ...
          <div className="absolute inset-0 overflow-hidden opacity-30">
            <svg className="absolute left-0 top-0 h-full" viewBox="0 0 150 800" xmlns="http://www.w3.org/2000/svg">
              <path d="M-40.4,645.5c29-39.5,120.8-31.9,151.2-70.3s-94-59.5-77.4-96.3S159.5,384.2,113,348.6s-102-142.6-53.9-187.1S252.6,28.7,193.5,3.7" 
                stroke="url(#gradient)" strokeWidth="100" fill="none" />
              <defs>
            ...
            <svg className="absolute right-0 bottom-0 h-full transform rotate-180" viewBox="0 0 150 800" xmlns="http://www.w3.org/2000/svg">
              <path d="M-40.4,645.5c29-39.5,120.8-31.9,151.2-70.3s-94-59.5-77.4-96.3S159.5,384.2,113,348.6s-102-142.6-53.9-187.1S252.6,28.7,193.5,3.7" 
                stroke="url(#gradient2)" strokeWidth="100" fill="none" />
              <defs>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-20">
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
              Join thousands of users who trust Photopia with their precious memories. Get started with a free account.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4 max-w-md">
                Photopia helps you store, organize, and share your photos securely. 
                Our platform ensures your memories are preserved for generations to come.
              </p>
