        ...
        <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-900">
            ...
            <div className="flex-grow flex flex-col items-center justify-center px-4 text-center">
                <div className="mb-8 max-w-lg w-full">
                    ...
                    <h2 className="mt-2 text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{title}</h2>

                    <p className="mt-4 text-base text-gray-600 dark:text-gray-400 max-w-md mx-auto">{message}</p>

                    <div className="mt-4 px-4 py-2 bg-gray-100 dark:bg-gray-800 rounded-md inline-block">
                        <code className="text-sm text-gray-700 dark:text-gray-300 font-mono">{location.pathname}</code>
                    </div>
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 max-w-md mx-auto w-full">
                    ...
                    <Link to={isAuthenticated ? "/dashboard" : "/"} className="w-full sm:w-auto">
                        <Button icon={<Home className="h-4 w-4 mr-2" />} variant="gradient" className="w-full">
